...
from .models import Job, UserProfile, JobInteraction, User
import re
...
class JobRecommendationEngine:
    ...
    def extract_job_features(self, job):
        ...
        features.append(job.experience_level)
        features.append(job.job_type)
    ...
    def content_based_recommendations(self, user_id, num_recommendations=10):
        ...
        interacted_jobs = JobInteraction.objects.filter(
            user_id=user_id
    ...
    def calculate_user_similarity(self, user_id, target_user_id):
        ...
        user2_ratings = self.user_job_ratings.loc[target_user_id]
    ...
    def collaborative_filtering_recommendations(self, user_id, num_recommendations=10):
        """Generate collaborative filtering recommendations using Pearson correlation"""
